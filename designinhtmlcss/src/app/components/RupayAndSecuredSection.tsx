      ...
      <div className="max-w-7xl mx-auto p-[0px]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="group bg-white border border-gray-200 rounded-2xl p-3 md:p-8 mb-6 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
            <h3 className="text-h2 mb-4">What are RuPay Credit Cards?</h3>
          ...
          {/* UPI Integration */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-3 md:p-8 mb-6 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
            <h3 className="text-h2 mb-4">RuPay Credit Cards on UPI</h3>
            <p className="text-body text-gray-700 leading-relaxed mb-4">
          ...
          {/* Benefits */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-3 md:p-8 mb-6 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
            <h3 className="text-h2 mb-4">Key Benefits</h3>
          ...
          {/* How to Link */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-3 md:p-8 mb-6 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
            <h3 className="text-h2 mb-4">How to Link RuPay Credit Card to UPI</h3>
          ...
          <div className="bg-black text-white rounded-lg p-3 md:p-8">
            <h3 className="text-h2 text-white mb-4">Popular RuPay Credit Cards</h3>
    ...
    <section className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto p-[0px]">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="group bg-white border border-gray-200 rounded-2xl p-3 md:p-8 mb-6 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
            <h3 className="text-h2 mb-4">What are Secured Credit Cards?</h3>
          ...
          {/* How They Work */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-3 md:p-8 mb-6 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
            <h3 className="text-h2 mb-4">How Do Secured Credit Cards Work?</h3>
            <ol className="space-y-3 text-body">
              <li className="flex gap-3">
                <span className="text-black font-bold">1.</span>
          ...
          {/* Benefits */}
          <div className="group bg-white border border-gray-200 rounded-2xl p-3 md:p-8 mb-6 hover:border-gray-300 transition-all duration-200 hover:shadow-md">
            <h3 className="text-h2 mb-4">Benefits of Secured Credit Cards</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="border-l-4 border-black pl-4">
                <h4 className="text-h3 mb-2">Easy Approval</h4>
                <p className="text-body text-gray-700">No credit history or income proof required in most cases</p>
              </div>
              <div className="border-l-4 border-black pl-4">
                <h4 className="text-h3 mb-2">Build Credit Score</h4>
                <p className="text-body text-gray-700">Establish or improve your credit history with responsible usage</p>
              </div>
              <div className="border-l-4 border-black pl-4">
                <h4 className="text-h3 mb-2">Earn Interest on FD</h4>
                <p className="text-body text-gray-700">Your fixed deposit continues to earn interest</p>
              </div>
              <div className="border-l-4 border-black pl-4">
                <h4 className="text-h3 mb-2">Upgrade to Regular Card</h4>
                <p className="text-body text-gray-700">After 6-12 months, upgrade to unsecured card</p>
              </div>
              <div className="border-l-4 border-black pl-4">
                <h4 className="text-h3 mb-2">All Card Benefits</h4>
                <p className="text-body text-gray-700">Access to rewards, cashback, and offers</p>
              </div>
              <div className="border-l-4 border-black pl-4">
                <h4 className="text-h3 mb-2">Low Risk</h4>
                <p className="text-body text-gray-700">Collateral protects both you and the bank</p>
              </div>
            </div>
          </div>
          ...
          {/* Who Should Apply */}
          <div className="bg-black text-white rounded-lg p-3 md:p-8">
            <h3 className="text-h2 text-white mb-4">Who Should Apply for Secured Credit Cards?</h3>
            <ul className="space-y-2 text-body text-white">
              <li className="flex gap-3">
                <span className="font-bold">•</span>
